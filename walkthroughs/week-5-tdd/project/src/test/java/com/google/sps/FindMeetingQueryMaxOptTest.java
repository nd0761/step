...
public final class FindMeetingQueryMaxOptTest {
  ...
  private static final int TIME_0600AM = TimeRange.getTimeInMinutes(6, 0);
  private static final int TIME_0630AM = TimeRange.getTimeInMinutes(6, 30);
  private static final int TIME_0800AM = TimeRange.getTimeInMinutes(8, 0);
  private static final int TIME_0820AM = TimeRange.getTimeInMinutes(8, 20);
  ...
  private FindMeetingQueryMaxOptional query;

  @Before
  public void setUp() {
    query = new FindMeetingQueryMaxOptional();
  }
  ...
  public void everyAttendeeIsConsideredNew01() {
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event("Event 3", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0820AM, false),
  ...
  @Test
  public void everyAttendeeIsConsideredNew02() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    //                       |--C---| |--D---|
  ...
  public void newTestOnlyOptional01() {
    ...
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TIME_0600AM,TIME_0630AM, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0800AM,TIME_0820AM, false),
            Arrays.asList(PERSON_B)),
    ...
    Collection<TimeRange> expected =
        Arrays.asList(TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0600AM, false),
                      TimeRange.fromStartEnd(TIME_0630AM, TIME_0800AM, false),
                      TimeRange.fromStartEnd(TIME_0820AM, TIME_0900AM, false),
                      TimeRange.fromStartEnd(TIME_0930AM, TimeRange.END_OF_DAY, true));
